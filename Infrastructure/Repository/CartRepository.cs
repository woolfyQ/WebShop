...
namespace Infrastructure.Repository
{
    public class CartRepository : ICartInterface<Cart, CartDTO>
    {
        ...
        public Task<Cart> AddItemToCart(CartDTO cartDTO, ItemCartDTO itemCartDTO, CancellationToken cancellationToken)
        {
        ...
        public Task<Cart> RemoveItemFromCart(Guid cartId, Guid productId)
        {
            throw new NotImplementedException();
        }
    }
